...
let searchQuery="";`r`n`r`nlet activeStatus="ALL";
...
articles=articles.filter(a=>
a.status &&
a.status.toLowerCase()===activeStatus.toLowerCase()
);
...
status:console.log("STATUS DIKIRIM:", $("status").value) || $("status").value,
...
activeCategory=e.target.dataset.cat;`r`n`r`nloadCMS();
